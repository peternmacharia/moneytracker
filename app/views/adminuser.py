...
from app.forms.user import UserDetailsForm, UserUpdateForm
from app.forms.auth import AdminRegistrationForm, ChangePasswordForm
...
@admin_bp.route('/details/<string:user_id>/', methods=['GET'])
@login_required
def details(user_id):
    """
...
def create():
    ...
    form.role.choices = [('', 'Select Role')] + [(r.id, r.name)
...
@admin_bp.route('/update/<string:user_id>/', methods=['GET', 'POST'])
@login_required
def update(user_id):
    """
...
@admin_bp.route('/changepassword/<string:user_id>/', methods=['GET', 'POST'])
@login_required
...
@admin_bp.route('/delete/<string:user_id>/', methods=['GET', 'POST'])
@login_required
def delete(user_id):
    """
